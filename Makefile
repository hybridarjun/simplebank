postgres:
	docker run --name postgres14 -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=secretpassword -d postgres:14.5-alpine
...
mock  :
	mockgen -package mockdb -destination db/mock/store.go newmigrate/db/sqlc Store
